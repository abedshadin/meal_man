      ...
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal p-0">
            ...
            <li tabIndex="5">
              <button className='btn rounded-lg ml-2 font-bold z-10 text-white'>
                Reports
                <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" /></svg>
              </button>
              <ul className="p-2 z-50">

              <li className='mt-1'>    <NavLink to="/individual" className="btn">Individual</NavLink></li>
              <li className='mt-1'>    <NavLink to="/all" className="btn">All</NavLink></li>
              <li className='mt-1'>    <NavLink to="/pay" className="btn">Pay</NavLink></li>
              <li className='mt-1'>    <NavLink to="/kreport" className="btn">Khala Repo</NavLink></li>
              <li className='mt-1'>    <NavLink to="/breport" className="btn">Bazar Repo</NavLink></li>
              </ul>
            </li>
