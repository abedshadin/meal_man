...
const Payment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const addReceipt = {
      firmName: searchText,
      tender_id: e.target.tender_id.value,
      rate: e.target.rate.value,
      amount: m_amount,
      pay: parseInt(e.target.pay.value),
      due: payment,
      t_method: e.target.t_method.value,
      t_purpose: e.target.t_purpose.value,
      comment: comment,
      date: newDate,
    ...
    fetch(`https://new-aghgfhfgh.herokuapp.com/receipt`, {
      method: "Post",
      body: JSON.stringify(addReceipt),
      headers: {
              ...
              <div className="card sm:w-94 lg:w-96 bg-neutral text-neutral-content">
                <div className="card-body items-center text-center">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <select name="Week" className="input input-bordered w-full max-w-xs mb-2 text-black">
                   ...
                   <input type="text"  name="amount" placeholder="Amount" className="input input-bordered w-full max-w-xs mb-2 text-black" />
